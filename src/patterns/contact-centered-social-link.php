 ...
 * Slug: brotherlylovepropertiesblockthemev2/contact-centered-social-link
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-group alignwide">
		...
		<p class="has-text-align-center is-style-text-display" style="font-style:normal;font-weight:400"><?php echo wp_kses_post( _x( 'Got questions? <br><a href="#" rel="nofollow">Feel free to reach out.</a>', 'Heading of the Contact social link pattern', 'brotherlylovepropertiesblockthemev2' ) ); ?></p>
		<!-- /wp:paragraph -->
