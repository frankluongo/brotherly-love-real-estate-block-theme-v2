 ...
 * Slug: brotherlyloverealestateblocktheme/post-with-left-aligned-content
	...
	<main class="wp-block-group alignwide">
				...
				<div class="wp-block-column" style="flex-basis:40%">
					...
					<div class="wp-block-group alignwide">
						...
						<div class="wp-block-group has-small-font-size">
							<!-- wp:paragraph -->
							<p><?php echo esc_html_x( 'by', 'Prefix before the author name. The post author name is displayed in a separate block.', 'brotherlyloverealestateblocktheme' ); ?></p>
							<!-- /wp:paragraph -->
		...
		<div class="wp-block-group alignwide" style="margin-top:var(--wp--preset--spacing--60);margin-bottom:var(--wp--preset--spacing--60)">
			...
			<div class="wp-block-group alignwide" style="border-top-color:var(--wp--preset--color--accent-6);border-top-width:1px">
				<!-- wp:group {"ariaLabel":"<?php esc_attr_e( 'Post navigation', 'brotherlyloverealestateblocktheme' ); ?>","tagName":"nav","align":"wide","style":{"spacing":{"padding":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"space-between"}} -->
				<nav class="wp-block-group alignwide" aria-label="<?php esc_attr_e( 'Post navigation', 'brotherlyloverealestateblocktheme' ); ?>" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
