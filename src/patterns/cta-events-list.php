...
/**
 * Title: Events list
 * Slug: brotherlyloverealestateblocktheme/cta-events-list
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		<!-- wp:heading -->
		<h2 class="wp-block-heading"><?php esc_html_e( 'Upcoming events', 'brotherlyloverealestateblocktheme' ); ?></h2>
		<!-- /wp:heading -->
		...
		<div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--70)">
			...
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)">
				...
				<div class="wp-block-group">
					<!-- wp:heading {"level":3} -->
					<h3 class="wp-block-heading"><?php esc_html_e( 'Tell your story', 'brotherlyloverealestateblocktheme' ); ?></h3>
					<!-- /wp:heading -->

					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Atlanta, GA, USA', 'brotherlyloverealestateblocktheme' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-group">
					...
					<p style="text-transform:uppercase"><?php echo esc_html_x( 'Mon, Jan 1', 'Example event date in pattern.', 'brotherlyloverealestateblocktheme' ); ?></p>
					<!-- /wp:paragraph -->

					<!-- wp:buttons -->
					<div class="wp-block-buttons">
						<!-- wp:button {"fontSize":"small"} -->
						<div class="wp-block-button has-custom-font-size has-small-font-size"><a class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Buy Tickets', 'brotherlyloverealestateblocktheme' ); ?></a></div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
				</div>
				...
				<div class="wp-block-group">
					...
					<h3 class="wp-block-heading">
						...
						echo wp_kses_post(
							...
							_x( '“Stories, <span lang="es">historias</span>, <span lang="uk">iсторії</span>, <span lang="el">iστορίες</span>”', 'Placeholder heading in four languages.', 'brotherlyloverealestateblocktheme' )
						);
						?>
					</h3>
					<!-- /wp:heading -->
					...
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Mexico City, Mexico', 'brotherlyloverealestateblocktheme' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			...
			<div class="wp-block-group" style="border-top-color:var(--wp--preset--color--accent-6);border-top-width:1px;padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40)"><!-- wp:group {"layout":{"type":"constrained"}} -->
				<div class="wp-block-group">
					...
					<!-- wp:paragraph -->
					<p><?php esc_html_e( 'Thornville, OH, USA', 'brotherlyloverealestateblocktheme' ); ?></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
