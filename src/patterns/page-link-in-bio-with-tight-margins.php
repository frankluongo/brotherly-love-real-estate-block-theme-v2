 ...
 * Slug: brotherlylovepropertiesblockthemev2/page-link-in-bio-with-tight-margins
 * Categories: brotherlylovepropertiesblockthemev2_page, banner
 * Keywords: starter
	...
	<div class="wp-block-columns alignfull">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover is-light" style="min-height:100vh">
				...
				<img class="wp-block-cover__image-background" alt="<?php esc_attr_e( 'Black and white photo focusing on a woman and a child from afar.', 'brotherlylovepropertiesblockthemev2' ); ?>" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/link-in-bio-image.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<p class="has-text-align-left has-x-large-font-size" style="line-height:1.2"><?php esc_html_e( 'I’m Asahachi Kōno, a Japanese photographer, a member of Los Angeles’s Japanese Camera Pictorialists of California. Before returning to Japan, I worked as a photo retoucher.', 'brotherlylovepropertiesblockthemev2' ); ?></p>
				<!-- /wp:paragraph -->
