...
/**
 * Title: CV/bio
 * Slug: brotherlyloverealestateblocktheme/page-cv-bio
 * Categories: brotherlyloverealestateblocktheme_page, about, featured
 * Keywords: starter
	...
	<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column" style="flex-basis:35%">
				...
				<div class="wp-block-group">
					...
					<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/woman-splashing-water.webp" alt="<?php esc_attr_e( 'Woman on beach, splashing water.', 'brotherlyloverealestateblocktheme' ); ?>" style="aspect-ratio:3/4;object-fit:cover"/></figure>
					<!-- /wp:image -->

					<!-- wp:paragraph {"align":"right","style":{"typography":{"lineHeight":"1.2"}},"fontSize":"x-large"} -->
					<p class="has-text-align-right has-x-large-font-size" style="line-height:1.2"><a href="#"><?php esc_html_e( 'Instagram', 'brotherlyloverealestateblocktheme' ); ?></a><br><a href="#"><?php esc_html_e( 'LinkedIn', 'brotherlyloverealestateblocktheme' ); ?></a><br><a href="#"><?php echo esc_html_x( 'Now', 'Link to a page with information about what the person is working on right now.', 'brotherlyloverealestateblocktheme' ); ?></a></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
