...
/**
 * Title: Event RSVP
 * Slug: blreblocktheme/event-rsvp
	...
	<div class="wp-block-columns alignfull is-not-stacked-on-mobile" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--40)">
		...
		<div class="wp-block-column" style="flex-basis:66.66%">
			...
			<div class="wp-block-group">
				...
				<p class="has-x-large-font-size"><?php echo esc_html_x( 'Mon, Jan 1', 'Example event date in pattern.', 'blreblocktheme' ); ?></p>
				<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				...
				<p class="has-text-align-left" style="line-height:0.6;text-transform:uppercase;writing-mode:vertical-rl"><?php esc_html_e( 'Free Workshop', 'blreblocktheme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->
		</div>
	...
	<div class="wp-block-columns alignfull is-style-section-2" style="padding-top:0;padding-bottom:0">
		...
		<div class="wp-block-column" style="flex-basis:50%">
			...
			<div class="wp-block-group" style="min-height:33vh;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
				<!-- wp:paragraph -->
				<p><?php esc_html_e( 'This immersive event celebrates the universal human experience through the lenses of history and ancestry, featuring a diverse array of photographers whose works capture the essence of different cultures and historical moments.', 'blreblocktheme' ); ?></p>
				<!-- /wp:paragraph -->
				...
				<!-- wp:heading {"fontSize":"xx-large"} -->
				<h2 class="wp-block-heading has-xx-large-font-size"><a href="#"><?php echo esc_html_x( 'RSVP', 'Abbreviation for "Please respond".', 'blreblocktheme' ); ?></a></h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:group -->
		</div>
