 ...
 * Slug: blreblocktheme/event-3-col
 * Categories: banner
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<h2 class="wp-block-heading has-x-large-font-size"><?php esc_html_e( 'Events', 'blreblocktheme' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide" style="padding-top:0;padding-bottom:0">
		...
		<div class="wp-block-column" style="padding-top:var(--wp--preset--spacing--70)">
			...
			<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/ruins-image.webp' ); ?>" alt="<?php esc_attr_e( 'Event image', 'blreblocktheme' ); ?>"/></figure>
			<!-- /wp:image -->
			...
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--30)">
				...
				<h3 class="wp-block-heading" style="padding-top:var(--wp--preset--spacing--20)"><?php esc_html_e( 'Tell your story', 'blreblocktheme' ); ?></h3>
				<!-- /wp:heading -->

				<!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|accent-4"}}}},"textColor":"accent-4","fontSize":"medium"} -->
				<p class="has-accent-4-color has-text-color has-link-color has-medium-font-size"><?php echo esc_html_x( 'Mon, Jan 1', 'Example event date in pattern.', 'blreblocktheme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:group -->

			<!-- wp:paragraph {"style":{"spacing":{"padding":{"top":"var:preset|spacing|40"}}}} -->
			<p style="padding-top:var(--wp--preset--spacing--40)"><a href="#"><?php esc_html_e( 'Event details', 'blreblocktheme' ); ?></a></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
