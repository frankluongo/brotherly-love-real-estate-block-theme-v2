 ...
 * Slug: brotherlylovepropertiesblockthemev2/banner-cover-big-heading
...
<div class="wp-block-group alignfull is-style-section-3" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-group alignwide">
		...
		<figure class="wp-block-image alignwide size-full">
			<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/coming-soon-bg-image.webp" alt="<?php esc_attr_e( 'Photo of a field full of flowers, a blue sky and a tree.', 'brotherlylovepropertiesblockthemev2' ); ?>"/>
		</figure>
		<!-- /wp:image -->
		...
		<div class="wp-block-group alignfull">
			...
			<h2 class="wp-block-heading has-text-align-left" style="font-size:clamp(1rem, 380px, 24vw);font-style:normal;font-weight:700;letter-spacing:-0.02em;line-height:1"><?php echo esc_html_e( 'Stories', 'brotherlylovepropertiesblockthemev2' ); ?></h2>
			<!-- /wp:heading -->
