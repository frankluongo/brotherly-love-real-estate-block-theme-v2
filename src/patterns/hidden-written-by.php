...
/**
 * Title: Written by
 * Slug: brotherlylovepropertiesblockthemev2/hidden-written-by
 * Inserter: no
 *
 * @package    WordPress
...
<div class="wp-block-group has-accent-4-color has-text-color has-link-color has-small-font-size" style="margin-bottom:var(--wp--preset--spacing--60)">
	<!-- wp:paragraph -->
	<p><?php esc_html_e( 'Written by ', 'brotherlylovepropertiesblockthemev2' ); ?></p>
	<!-- /wp:paragraph -->
	<!-- wp:post-author-name {"isLink":true} /-->
	<!-- wp:paragraph -->
	<p><?php esc_html_e( 'in', 'brotherlylovepropertiesblockthemev2' ); ?></p>
	<!-- /wp:paragraph -->
