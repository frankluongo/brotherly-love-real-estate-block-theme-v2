 ...
 * Slug: blreblocktheme/hero-overlapped-book-cover-with-links
 * Categories: banner
		...
		<div class="wp-block-columns alignwide">
				...
				<div class="wp-block-group" style="min-height:100%">
					...
					<div class="wp-block-group">
						...
						<h2 class="wp-block-heading has-xx-large-font-size">
							<?php echo esc_html_x( 'The Stories Book', 'Hero - Overlapped book cover pattern headline text', 'blreblocktheme' ); ?>
						</h2>
						<!-- /wp:heading -->

						<!-- wp:paragraph {"className":"is-style-text-subtitle"} -->
						<p class="is-style-text-subtitle">
							<?php echo esc_html_x( 'A fine collection of moments in time featuring photographs from Louis Fleckenstein, Paul Strand and Asahachi Kōno.', 'Hero - Overlapped book cover pattern subline text', 'blreblocktheme' ); ?>
						</p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
					...
					<div class="wp-block-group">
						...
						<div class="wp-block-columns">
								...
								<div class="wp-block-buttons">
									...
									<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill">
										<a class="wp-block-button__link wp-element-button" href="#">
											<?php echo esc_html_x( 'Amazon', 'Example brand name.', 'blreblocktheme' ); ?>
										</a>
									</div>
									<!-- /wp:button -->
									<!-- wp:button {"width":100,"className":"is-style-fill"} -->
									<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill">
										<a class="wp-block-button__link wp-element-button" href="#">
											<?php echo esc_html_x( 'Apple Books', 'Example brand name.', 'blreblocktheme' ); ?>
										</a>
									</div>
									<!-- /wp:button -->
								</div>
							...
							<div class="wp-block-column is-vertically-aligned-stretch">
								...
								<div class="wp-block-buttons">
									...
									<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill">
										<a class="wp-block-button__link wp-element-button" href="#">
											<?php echo esc_html_x( 'Audible', 'Example brand name.', 'blreblocktheme' ); ?>
										</a>
									</div>
									<!-- /wp:button -->
									<!-- wp:button {"width":100,"className":"is-style-fill"} -->
									<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-fill">
										<a class="wp-block-button__link wp-element-button" href="#">
											<?php echo esc_html_x( 'Barnes &amp; Noble', 'Example brand name.', 'blreblocktheme' ); ?>
										</a>
									</div>
									<!-- /wp:button -->
								</div>
						...
						<p class="has-medium-font-size"><?php echo wp_kses_post( _x( 'Outside Europe? View <a href="#" rel="nofollow">international editions</a>.', 'Pattern placeholder text with link.', 'blreblocktheme' ) ); ?></p>
						<!-- /wp:paragraph -->
					</div>
					<!-- /wp:group -->
				</div>
			...
			<div class="wp-block-column is-vertically-aligned-top" style="flex-basis:45%">
				...
				<figure class="wp-block-image size-full">
					<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/book-image.webp" alt="<?php echo esc_attr__( 'Book Image', 'blreblocktheme' ); ?>" style="aspect-ratio:3/4;object-fit:cover"/>
				</figure>
				<!-- /wp:image -->
			</div>
			<!-- /wp:column -->
