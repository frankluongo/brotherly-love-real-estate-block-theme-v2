 ...
 * Slug: brotherlyloverealestateblocktheme/template-home-with-sidebar-news-blog
...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column" style="flex-basis:25%">
			...
			<h2 class="wp-block-heading has-small-font-size" style="font-style:normal;font-weight:600;letter-spacing:1.6px;text-transform:uppercase"><?php esc_html_e( 'The Latest', 'brotherlyloverealestateblocktheme' ); ?></h2>
			<!-- /wp:heading -->
			...
			<div class="wp-block-query">
				...
				<!-- /wp:post-template -->
				<!-- wp:query-no-results -->
					<!-- wp:paragraph {"placeholder":"<?php esc_attr_e( 'Add text or blocks that will display when a query returns no results.', 'brotherlyloverealestateblocktheme' ); ?>","fontSize":"medium"} -->
					<p class="has-medium-font-size"><?php echo esc_html_x( 'Sorry, but nothing was found. Please try a search with different keywords.', 'Message explaining that there are no results returned from a search.', 'brotherlyloverealestateblocktheme' ); ?></p>
					<!-- /wp:paragraph -->
				<!-- /wp:query-no-results -->
			</div>
			<!-- /wp:query -->
