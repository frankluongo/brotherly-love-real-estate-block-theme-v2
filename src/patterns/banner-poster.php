 ...
 * Slug: brotherlyloverealestateblocktheme/banner-poster
	...
	<div class="wp-block-group alignwide" style="min-height:100vh">
		...
		<div class="wp-block-columns alignwide">
			...
			<div class="wp-block-column" style="flex-basis:20%">
				...
				<p class="has-text-align-right"><?php echo esc_html_x( 'Aug 08—10 2025', 'Example event date in pattern.', 'brotherlyloverealestateblocktheme' ); ?><br><?php esc_html_e( 'Fuego Bar, Mexico City', 'brotherlyloverealestateblocktheme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
		</div>
		...
		<div class="wp-block-columns alignwide are-vertically-aligned-bottom is-not-stacked-on-mobile">
			...
			<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:80%">
				...
				<h2 class="wp-block-heading alignwide has-text-align-left has-xx-large-font-size" style="font-style:normal;font-weight:300;line-height:0.9"><?php esc_html_e( 'Let’s hear them.', 'brotherlyloverealestateblocktheme' ); ?></h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:column -->
			...
			<div class="wp-block-column is-vertically-aligned-bottom" style="flex-basis:20%">
				<!-- wp:paragraph {"align":"right"} -->
				<p class="has-text-align-right"><?php esc_html_e( '#stories', 'brotherlyloverealestateblocktheme' ); ?></p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
		</div>
