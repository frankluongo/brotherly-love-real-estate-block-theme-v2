 ...
 * Slug: brotherlyloverealestateblocktheme/template-query-loop-news-blog
 * Inserter: no
 *
 * @package WordPress
...
<div class="wp-block-group">
	...
	<p class="has-accent-4-color has-text-color has-link-color has-small-font-size"><?php echo esc_html_x( 'Written by', 'Prefix before the author name. The post author name is displayed in a separate block.', 'brotherlyloverealestateblocktheme' ); ?></p>
	<!-- /wp:paragraph -->
...
<!-- wp:query-pagination-previous {"label":"<?php esc_html_e( 'Newer Posts', 'brotherlyloverealestateblocktheme' ); ?>"} /-->

<!-- wp:query-pagination-numbers /-->

<!-- wp:query-pagination-next {"label":"<?php esc_html_e( 'Older Posts', 'brotherlyloverealestateblocktheme' ); ?>"} /-->
