...
/**
 * Title: Logos
 * Slug: brotherlylovepropertiesblockthemev2/logos
 * Categories: banner
...
<div class="wp-block-group alignfull is-style-section-1" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)">
	...
	<h2 class="wp-block-heading has-text-align-center"><?php esc_html_e( 'The Stories Podcast is sponsored by', 'brotherlylovepropertiesblockthemev2' ); ?></h2>
	<!-- /wp:heading -->
