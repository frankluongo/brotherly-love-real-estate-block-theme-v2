 ...
 * Slug: blreblocktheme/page-link-in-bio-heading-paragraph-links-image
 * Categories: blreblocktheme_page, banner, featured
 * Keywords: starter
	...
	<div class="wp-block-columns alignfull">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
				<!-- wp:heading -->
				<h2 class="wp-block-heading"><?php esc_html_e( 'Lewis Hine', 'blreblocktheme' ); ?></h2>
				<!-- /wp:heading -->

				<!-- wp:paragraph -->
				<p><?php esc_html_e( 'Lewis W. Hine studied sociology before moving to New York in 1901 to work at the Ethical Culture School, where he took up photography to enhance his teaching practices', 'blreblocktheme' ); ?></p>
				<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover" style="min-height:100vh"><span aria-hidden="true" class="wp-block-cover__background has-background-dim-0 has-background-dim" style="background-color:#6b6b6b"></span>
				<img class="wp-block-cover__image-background" alt="<?php esc_attr_e( 'Photo of a woman worker.', 'blreblocktheme' ); ?>" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/link-in-bio-background.webp" data-object-fit="cover"/><div class="wp-block-cover__inner-container">
