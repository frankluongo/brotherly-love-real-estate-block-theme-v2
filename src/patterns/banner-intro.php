 ...
 * Slug: brotherlylovepropertiesblockthemev2/banner-intro
 * Categories: banner
	...
	<h2 class="wp-block-heading alignwide has-x-large-font-size">
		<?php
			printf(
				...
				esc_html_x( 'We\'re %s, our mission is to deliver exquisite flower arrangements that not only adorn living spaces but also inspire a deeper appreciation for natural beauty.', 'Pattern placeholder text.', 'brotherlylovepropertiesblockthemev2' ),
