 ...
 * Slug: brotherlylovepropertiesblockthemev2/page-portfolio-home
 * Categories: brotherlylovepropertiesblockthemev2_page, posts
 * Keywords: starter
	...
	<div class="wp-block-group alignfull" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-columns alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--50)">
			...
			<div class="wp-block-column" style="flex-basis:50%">
				...
				<h2 class="wp-block-heading alignwide has-x-large-font-size"><?php esc_html_e( 'My name is Anna Möller and these are some of my photo projects.', 'brotherlylovepropertiesblockthemev2' ); ?></h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:column -->
...
<div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0">
	...
	<div class="wp-block-group alignwide">
		...
		<div class="wp-block-group alignwide">
			...
			<!-- /wp:paragraph -->
			<!-- wp:paragraph {"fontSize":"small"} -->
			<p class="has-small-font-size"><?php esc_html_e( 'email@example.com', 'brotherlylovepropertiesblockthemev2' ); ?><br><?php echo esc_html_x( '+1 555 349 1806', 'Phone number.', 'brotherlylovepropertiesblockthemev2' ); ?></p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
