 ...
 * Slug: brotherlylovepropertiesblockthemev2/page-link-in-bio-wide-margins
	...
	<div class="wp-block-columns alignwide are-vertically-aligned-center">
		...
		<div class="wp-block-column is-vertically-aligned-center">
			...
			<div class="wp-block-group">
				...
				<h2 class="wp-block-heading has-text-align-left"><?php esc_html_e( 'Nora Winslow Keene', 'brotherlylovepropertiesblockthemev2' ); ?></h2>
				<!-- /wp:heading -->

				<!-- wp:paragraph -->
				<p><?php echo esc_html_x( 'I’m Nora, a dedicated public interest attorney based in Denver. I’m a graduate of Stanford University.', 'Pattern placeholder text.', 'brotherlylovepropertiesblockthemev2' ); ?></p>
				<!-- /wp:paragraph -->
