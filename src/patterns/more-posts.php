...
/**
 * Title: More posts
 * Slug: brotherlyloverealestateblocktheme/more-posts
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
	...
	<h2 class="wp-block-heading alignwide has-small-font-size" style="font-style:normal;font-weight:700;letter-spacing:1.4px;text-transform:uppercase"><?php esc_html_e( 'More posts', 'brotherlyloverealestateblocktheme' ); ?></h2>
	<!-- /wp:heading -->
