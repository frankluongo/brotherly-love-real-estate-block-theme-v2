 ...
 * Slug: brotherlylovepropertiesblockthemev2/cta-heading-search
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:group {"align":"wide","layout":{"type":"default"}} -->
	<div class="wp-block-group alignwide">
		...
		<h2 class="wp-block-heading has-xx-large-font-size"><?php esc_html_e( 'What are you looking for?', 'brotherlylovepropertiesblockthemev2' ); ?></h2>
		<!-- /wp:heading -->
