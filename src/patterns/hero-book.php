...
/**
 * Title: Hero book
 * Slug: brotherlyloverealestateblocktheme/hero-book
 * Categories: banner
	...
	<div class="wp-block-columns alignfull">
		...
		<div class="wp-block-column" style="flex-basis:55%">
			...
			<div class="wp-block-cover is-light">
				...
				<img class="wp-block-cover__image-background" alt="<?php esc_attr_e( 'Image of the book', 'brotherlyloverealestateblocktheme' ); ?>" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/book-image-landing.webp" data-object-fit="cover"/>
...
<!-- wp:heading -->
<h2 class="wp-block-heading has-xx-large-font-size"><?php echo esc_html_x( 'The Stories Book', 'Heading of the hero section.', 'brotherlyloverealestateblocktheme' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><?php echo esc_html_x( 'A fine collection of moments in time featuring photographs from Louis Fleckenstein, Paul Strand and Asahachi Kōno.', 'Content of the hero section.', 'brotherlyloverealestateblocktheme' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"fontSize":"medium"} -->
<p class="has-medium-font-size"><?php echo esc_html_x( 'Available for pre-order now.', 'CTA text of the hero section.', 'brotherlyloverealestateblocktheme' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group -->
