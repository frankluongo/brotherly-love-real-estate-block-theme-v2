 ...
 * Slug: blreblocktheme/testimonials-2-col
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column" style="flex-basis:64px">
					...
					<figure class="wp-block-image size-large is-resized is-style-rounded"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/nurse.webp" alt="<?php echo esc_attr_x( 'Picture of a person', 'Alt text for testimonial image.', 'blreblocktheme' ); ?>" style="aspect-ratio:1;object-fit:cover;width:64px"/></figure>
					<!-- /wp:image -->
				</div>
				<!-- /wp:column -->
				...
				<div class="wp-block-column">
					...
					<blockquote class="wp-block-quote is-style-plain has-x-large-font-size" style="font-style:normal;font-weight:400">
						...
						<p style="line-height:1.1"><?php echo esc_html_x( '“Superb product and customer service!”', 'Sample testimonial.', 'blreblocktheme' ); ?></p>
						<!-- /wp:paragraph -->
						<cite><?php echo wp_kses_post( _x( 'Jo Mulligan <br /><sub>Atlanta, GA</sub>', 'Sample testimonial citation.', 'blreblocktheme' ) ); ?></cite>
					</blockquote>
					<!-- /wp:quote -->
				</div>
				<!-- /wp:column -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<blockquote class="wp-block-quote is-style-plain has-x-large-font-size" style="font-style:normal;font-weight:400">
						<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.1"}}} -->
						<p style="line-height:1.1"><?php echo esc_html_x( '“Amazing quality and care. I love all your products.”', 'Sample testimonial.', 'blreblocktheme' ); ?></p>
						<!-- /wp:paragraph -->
						<cite><?php echo wp_kses_post( _x( 'Otto Reid <br><sub>Springfield, IL</sub>', 'Sample testimonial citation.', 'blreblocktheme' ) ); ?></cite>
					</blockquote>
					<!-- /wp:quote -->
				</div>
				<!-- /wp:column -->
