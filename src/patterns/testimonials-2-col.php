 ...
 * Slug: brotherlyloverealestateblocktheme/testimonials-2-col
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<blockquote class="wp-block-quote is-style-plain has-x-large-font-size" style="font-style:normal;font-weight:400">
						...
						<p style="line-height:1.1"><?php echo esc_html_x( '“Superb product and customer service!”', 'Sample testimonial.', 'brotherlyloverealestateblocktheme' ); ?></p>
						<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-columns">
				...
				<div class="wp-block-column">
					...
					<blockquote class="wp-block-quote is-style-plain has-x-large-font-size" style="font-style:normal;font-weight:400">
						<!-- wp:paragraph {"style":{"typography":{"lineHeight":"1.1"}}} -->
						<p style="line-height:1.1"><?php echo esc_html_x( '“Amazing quality and care. I love all your products.”', 'Sample testimonial.', 'brotherlyloverealestateblocktheme' ); ?></p>
						<!-- /wp:paragraph -->
						<cite><?php echo wp_kses_post( _x( 'Otto Reid <br><sub>Springfield, IL</sub>', 'Sample testimonial citation.', 'brotherlyloverealestateblocktheme' ) ); ?></cite>
					</blockquote>
					<!-- /wp:quote -->
				</div>
				<!-- /wp:column -->
