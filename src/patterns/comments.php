...
/**
 * Title: Comments
 * Slug: brotherlylovepropertiesblockthemev2/comments
...
<div class="wp-block-comments wp-block-comments-query-loop" style="margin-top:var(--wp--preset--spacing--70);margin-bottom:var(--wp--preset--spacing--70)">
	...
	<h2 class="wp-block-heading has-x-large-font-size"><?php esc_html_e( 'Comments', 'brotherlylovepropertiesblockthemev2' ); ?></h2>
	<!-- /wp:heading -->
