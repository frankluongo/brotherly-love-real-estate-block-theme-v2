 ...
 * Slug: brotherlylovepropertiesblockthemev2/template-home-posts-grid-news-blog
...
<main class="wp-block-group" style="margin-top:0;margin-bottom:0;">
	...
	<div class="wp-block-group" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-query alignwide">
			...
			<!-- /wp:post-template -->
			<!-- wp:query-no-results -->
				<!-- wp:paragraph {"align":"center","placeholder":"<?php esc_attr_e( 'Add text or blocks that will display when a query returns no results.', 'brotherlylovepropertiesblockthemev2' ); ?>"} -->
				<p class="has-text-align-center"><?php echo esc_html_x( 'Sorry, but nothing was found. Please try a search with different keywords.', 'Message explaining that there are no results returned from a search.', 'brotherlylovepropertiesblockthemev2' ); ?></p>
				<!-- /wp:paragraph -->
			<!-- /wp:query-no-results -->
		</div>
		<!-- /wp:query -->
	...
	<div class="wp-block-group alignwide" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)">
		...
		<h2 class="wp-block-heading alignwide"><?php esc_html_e( 'Architecture', 'brotherlylovepropertiesblockthemev2' ); ?></h2>
		<!-- /wp:heading -->
